...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for training in trainings_heute:
            ...
            training_gruppen_ids = set(training.gruppen.values_list("id", flat=True))
            if training_gruppen_ids:
                kinder = [k for k in kinder if k.gruppe and k.gruppe.id in training_gruppen_ids]
